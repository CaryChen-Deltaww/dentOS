...
#define B30GE6X1_FAN_DEF_CAP   ONLP_FAN_CAPS_F2B
...
static plat_fan_t plat_fans[] = {
    [PLAT_FAN_ID_1] = {
        ...
        .present_data = NULL,
        .rpm_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/fan1_input",
        .rpm_set_path = NULL,
        .max_rpm = 13000,
        .per_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm1",
        .per_set_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm1",
        .caps = B30GE6X1_FAN_DEF_CAP,
    ...
    [PLAT_FAN_ID_2] = {
        ...
        .present = _fan_present,
        .present_data = NULL,
        .rpm_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/fan2_input",
        .rpm_set_path = NULL,
        .max_rpm = 13000,
        .per_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm2",
        .per_set_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm2",
        .caps = B30GE6X1_FAN_DEF_CAP,
    ...
    [PLAT_FAN_ID_3] = {
        ...
        .present = _fan_present,
        .present_data = NULL,
        .rpm_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/fan3_input",
        .rpm_set_path = NULL,
        .max_rpm = 13000,
        .per_get_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm3",
        .per_set_path = "/sys/bus/i2c/devices/11-002e/hwmon/*/pwm3",
        .caps = B30GE6X1_FAN_DEF_CAP,

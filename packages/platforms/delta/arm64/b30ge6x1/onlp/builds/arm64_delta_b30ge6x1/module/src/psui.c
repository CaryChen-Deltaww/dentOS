...
static plat_psu_t plat_b30ge6x1_psus[] = {
    [PLAT_PSU_ID_1] = {
        .name = "PSU_EXT",
	.type = PLAT_PSU_TYPE_AC,
	.present = _psu_present,
        .present_path = "/sys/bus/i2c/devices/1-0031/psu_ext_present",
        .power_status_path = "/sys/bus/i2c/devices/1-0031/psu_ext_powergood",
        .state = PLAT_PSU_STATE_UNPRESENT,
    },
    [PLAT_PSU_ID_2] = {
        .name = "PSU_INT",
        .type = PLAT_PSU_TYPE_AC,
        .power_status_path = "/sys/bus/i2c/devices/0-0041/psu_int_powergood",

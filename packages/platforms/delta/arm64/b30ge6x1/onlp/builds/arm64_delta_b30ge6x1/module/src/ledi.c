...
static plat_led_t plat_leds[] = {
    [PLAT_LED_ID_1] = {
        .name = "Front LED - PSU",
        .led_get_path = "/sys/bus/i2c/devices/1-0031/led_pwr_status",
        .led_set_path = "/sys/bus/i2c/devices/1-0031/led_pwr_status",
        .mode = {
    ...
    [PLAT_LED_ID_2] = {
        .name = "Front LED - FAN",
        .led_get_path = "/sys/bus/i2c/devices/1-0031/led_fan_status",
        .led_set_path = "/sys/bus/i2c/devices/1-0031/led_fan_status",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_ORANGE, LED_MODE_AMBER),
    ...
    [PLAT_LED_ID_3] = {
        .name = "Front LED - SYS",
        .led_get_path = "/sys/bus/i2c/devices/1-0031/led_sys_status",
        .led_set_path = "/sys/bus/i2c/devices/1-0031/led_sys_status",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_ORANGE, LED_MODE_AMBER),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN_BLINKING,  LED_MODE_GREEN_BLINKING),
            PLAT_LED_MODE(ONLP_LED_MODE_ORANGE_BLINKING,  LED_MODE_AMBER_BLINKING),
            PLAT_LED_MODE_END,
        },
        PLAT_LED_INTERNAL_DEF,
    },
